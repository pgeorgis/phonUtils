...
from PhoneticSimilarity.phonSim import normalize_ipa_ch, _toSegment, _is_vowel, segment_ipa
from PhoneticSimilarity.phonSim import (vowels, consonants, 
...
#Functions and classes related to syllable types
...
def syllabify(word, max_onset=2, max_coda=2, illegal_coda=[], illegal_onset=[], default_coda=True, g_open=True, split_affricate=False):
...
#General phonological functions
