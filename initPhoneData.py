...
diphthong_regex = re.compile(fr'([{vowel_str}]̯[{diacritic_str}]*[{vowel_str}])|([{vowel_str}][{diacritic_str}]*[{vowel_str}]̯)')
affricate_regex = re.compile(rf'[{plosive_str}].*͡.*[{fricative_str}]')
geminate_regex = re.compile(rf'([{pre_diacritics}]*[{consonants}][{post_diacritics}]*)\1')
